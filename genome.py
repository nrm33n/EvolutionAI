...
class Genome():
    ...
    @staticmethod
    def get_gene_spec():
        gene_spec =  {"link-shape":{"scale":2}, #cylinder or box
            "link-length": {"scale":4},
            "link-radius": {"scale":0.75},
            "link-recurrence": {"scale":2}, #how many legs he got
            "link-mass": {"scale":4},
            "joint-type": {"scale":1}, #revolute/fixed
            "joint-parent":{"scale":1},
            "joint-axis-xyz": {"scale":2}, #controlled by # of links 
            "joint-origin-rpy-1":{"scale":np.pi * 3},
            "joint-origin-rpy-2":{"scale":np.pi * 4},
            "joint-origin-rpy-3":{"scale":np.pi * 4},
            "joint-origin-xyz-1":{"scale":1}, #dist from parent link
            "joint-origin-xyz-2":{"scale":1},
            "joint-origin-xyz-3":{"scale":1},
            "control-waveform":{"scale":2},
            "control-amp":{"scale":0.75}, #max speed of motor
            "control-freq":{"scale":2} #max freq of motor 
            }
        ind = 0
...
class URDFLink:
    ...
    def to_joint_element(self, adom):
        ...
        #use siblings to determine angle of part 
        #solves overlapping robot 
