...
class TestGA(unittest.TestCase):
    def testBasicGA(self):
        ...
        #iteration is frames in pybullet to run for at 240 fps
        for iteration in range(1000):
            sim.eval_population(pop, 2400)

            #iterate over all creatures, determine dist travelled for each
            #and storing it back into an array
            ...
            for i in range(len(pop.creatures)):
                #pulls 2 weighted random parents 
                ...
                #rate = chance of mutation per number on gene 
                #amount = how much it will be mutated by 
